...
export const metadata: Metadata = {
    ...
    description: 'Read verified Custom Wedding Co. reviews from couples, wedding parties, and guests who ordered personalized wedding gifts, favors, and keepsakes.',
}

const highlights = [
    'Proofs before production',
    'Personalized wedding details',
    'Loved by couples and wedding parties',
]
    ...
    return (
        <main className="bg-cream text-espresso">
            <section className="relative overflow-hidden border-b border-gold/20 bg-cream-dark">
                ...
                <div className="relative mx-auto grid max-w-[1280px] gap-10 px-6 py-16 sm:py-20 lg:grid-cols-[0.95fr_1.05fr] lg:px-12 lg:py-24">
                    <div className="flex flex-col justify-center">
                        <span className="mb-5 font-sans text-xs font-bold uppercase tracking-[0.22em] text-gold">
                            Customer Love Wall
                        </span>
                        <h1 className="font-display text-5xl leading-none text-espresso sm:text-6xl lg:text-7xl">
            ...
            <section className="border-b border-gold/20 bg-espresso px-6 py-5 text-cream lg:px-12">
                <div className="mx-auto flex max-w-[1280px] flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div className="flex flex-wrap gap-5 font-sans text-xs font-semibold uppercase tracking-[0.16em] text-cream">
                        ...
                        <span className="flex items-center gap-2"><Camera className="h-4 w-4 text-gold" /> Customer photos included</span>
            ...
            <section className="mx-auto max-w-[1440px] px-4 py-12 sm:px-6 sm:py-16 lg:px-10">
                <div className="mb-10 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
                    ...
                    <p className="max-w-xl font-sans text-sm leading-relaxed text-gray-600">
                        Pulled from the product review export and arranged as a mixed gallery of photo reviews and text notes.
                    </p>
                </div>
