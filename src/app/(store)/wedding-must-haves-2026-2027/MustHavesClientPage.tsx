...
export interface MustHavesClientPageProps {
    allProducts: any[]
}

export function MustHavesClientPage({ allProducts }: MustHavesClientPageProps) {
    const [activeProductSlug, setActiveProductSlug] = useState<string | null>(null)

    // Find the currently selected product details
    const activeProduct = allProducts.find(p => p.slug === activeProductSlug || p.slug?.current === activeProductSlug)

    const handleOpenCustomizer = (slug: string, e?: React.MouseEvent) => {
    ...
    return (
        <main className="min-h-screen bg-cream text-espresso pb-24 md:pb-0">
            ...
            <section className="relative w-full min-h-[85vh] flex flex-col items-center justify-center">
                ...
                <div className="relative z-10 text-center px-4 max-w-5xl mx-auto space-y-6 pt-20">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mt-10 w-full sm:w-auto">
                        <Button variant="primary" size="lg" href="#must-haves" className="w-full sm:w-auto">
                            Shop the 2026 Must-Haves
                        </Button>
                        <Button variant="outline" size="lg" href="#must-haves" className="w-full sm:w-auto text-cream border-cream hover:bg-cream hover:text-espresso">
                            See the 4 Ideas
                        </Button>
                    </div>
            ...
            <section className="w-full py-12 px-6 bg-cream border-b border-gold/20">
                <div className="max-w-4xl mx-auto space-y-8 text-center">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <a href="#pint-glasses" className="p-4 border border-espresso/10 rounded hover:border-gold hover:shadow-md transition-all bg-white group flex flex-col items-center justify-center gap-2">
                        ...
                        <a href="#ceremony-fans" className="p-4 border border-espresso/10 rounded hover:border-gold hover:shadow-md transition-all bg-white group flex flex-col items-center justify-center gap-2">
                        ...
                        <a href="#agate-coasters" className="p-4 border border-espresso/10 rounded hover:border-gold hover:shadow-md transition-all bg-white group flex flex-col items-center justify-center gap-2">
                        ...
                        <a href="#acrylic-stirrers" className="p-4 border border-espresso/10 rounded hover:border-gold hover:shadow-md transition-all bg-white group flex flex-col items-center justify-center gap-2">
            ...
            <section id="must-haves" className="w-full py-10">
                ...
                <article id="pint-glasses" className="scroll-mt-24 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20 items-center py-16 px-6">
                    ...
                    <div className="space-y-6 order-2 md:order-2">
                        ...
                        <div className="pt-2">
                            <Button onClick={(e) => handleOpenCustomizer('bespoke-engraved-groomsmen-pint-glass', e)}>Shop Personalized Glassware</Button>
                        </div>
                    </div>
                </article>
                ...
                <article id="ceremony-fans" className="scroll-mt-24 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20 items-center py-16 px-6">
                    ...
                    <div className="space-y-6 order-2 md:order-1">
                        ...
                        <div className="pt-2">
                            <Button onClick={(e) => handleOpenCustomizer('bespoke-keepsake-handheld-fan', e)}>Shop Ceremony Fans</Button>
                        </div>
                    </div>
                </article>
                ...
                <div className="w-full bg-cream-dark py-20 px-6 my-10 text-center border-y border-gold/20">
                    <div className="max-w-3xl mx-auto space-y-8">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                            <Link href="/shop" className="w-full sm:w-auto inline-flex items-center justify-center font-sans transition-all duration-250 ease-in-out uppercase tracking-wider text-xs font-semibold bg-espresso text-cream hover:bg-espresso-light shadow-md hover:shadow-lg px-8 py-3.5">
                                Shop All Personalized Wedding Favors
                            </Link>
                            <Link href="/shop" className="w-full sm:w-auto inline-flex items-center justify-center font-sans transition-all duration-250 ease-in-out uppercase tracking-wider text-xs font-semibold border-2 border-gold text-espresso hover:bg-gold hover:text-cream px-8 py-3.5">
                                Explore Barware Details
                            </Link>
                        </div>
                    </div>
                </div>
                ...
                <article id="agate-coasters" className="scroll-mt-24 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20 items-center py-16 px-6">
                    ...
                    <div className="space-y-6 order-2 md:order-2">
                        ...
                        <div className="bg-white/50 border border-gold/20 p-4 rounded-sm flex flex-col gap-1 text-sm font-sans text-espresso/80 mb-6">
                            <span className="font-bold text-espresso">From $29.99</span>
                        ...
                        <div className="pt-2">
                            <Button onClick={(e) => handleOpenCustomizer('bespoke-gold-gilded-agate-coaster', e)}>Shop Agate Coasters</Button>
                        </div>
                    </div>
                </article>
                ...
                <article id="acrylic-stirrers" className="scroll-mt-24 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20 items-center py-16 px-6">
                    ...
                    <div className="space-y-6 order-2 md:order-1">
                        ...
                        <div className="bg-white/50 border border-gold/20 p-4 rounded-sm flex flex-col gap-1 text-sm font-sans text-espresso/80 mb-6">
                            <span className="font-bold text-espresso">From $45.00</span>
                        ...
                        <div className="pt-2">
                            <Button onClick={(e) => handleOpenCustomizer('bespoke-acrylic-cocktail-stirrers', e)}>Shop Acrylic Stirrers</Button>
                        </div>
                    </div>
                </article>
            ...
            <section className="w-full py-24 px-6 bg-cream border-t border-gold/20">
                <div className="max-w-7xl mx-auto space-y-12">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                        {/* Product 1 */}
                        <Link 
                            href="/products/bespoke-gold-embossed-passport-cover" 
                            onClick={(e) => handleOpenCustomizer('bespoke-gold-embossed-passport-cover', e)}
                        ...
                        >
                            ...
                            <div className="flex flex-col space-y-1 text-center">
                                ...
                                <span className="font-sans text-xs text-gold font-bold">$30.00</span>
                            </div>
                        </Link>

                        {/* Product 2 */}
                        <Link 
                            href="/products/bespoke-leather-cigar-case" 
                            onClick={(e) => handleOpenCustomizer('bespoke-leather-cigar-case', e)}
                            className="group flex flex-col space-y-4 cursor-pointer"
                        >
                            <div className="relative aspect-square w-full rounded-sm overflow-hidden bg-white/50 border border-espresso/5 shadow-sm group-hover:shadow-md transition-shadow">
                            ...
                            <div className="flex flex-col space-y-1 text-center">
                                ...
                                <span className="font-sans text-xs text-gold font-bold">$45.00</span>
                            </div>
                        </Link>

                        {/* Product 3 */}
                        <Link 
                            href="/products/gold-celebration-cannon" 
                            onClick={(e) => handleOpenCustomizer('gold-celebration-cannon', e)}
                            className="group flex flex-col space-y-4 cursor-pointer"
                        >
                            <div className="relative aspect-square w-full rounded-sm overflow-hidden bg-white/50 border border-espresso/5 shadow-sm group-hover:shadow-md transition-shadow">
                            ...
                            <div className="flex flex-col space-y-1 text-center">
                                ...
                                <span className="font-sans text-xs text-gold font-bold">$35.00</span>
                            </div>
                        </Link>

                        {/* Product 4 */}
                        <Link 
                            href="/products/bespoke-engraved-black-stainless-steel-chopsticks" 
                            onClick={(e) => handleOpenCustomizer('bespoke-engraved-black-stainless-steel-chopsticks', e)}
                            className="group flex flex-col space-y-4 cursor-pointer"
                        >
                            <div className="relative aspect-square w-full rounded-sm overflow-hidden bg-white/50 border border-espresso/5 shadow-sm group-hover:shadow-md transition-shadow">
                            ...
                            <div className="flex flex-col space-y-1 text-center">
                                ...
                                <span className="font-sans text-xs text-gold font-bold">$15.99</span>
                            </div>
                        </Link>

                        {/* Product 5 */}
                        <Link 
                            href="/products/heirloom-engraved-cutlery-set" 
                            onClick={(e) => handleOpenCustomizer('heirloom-engraved-cutlery-set', e)}
                            className="group flex flex-col space-y-4 cursor-pointer"
                        >
                            <div className="relative aspect-square w-full rounded-sm overflow-hidden bg-white/50 border border-espresso/5 shadow-sm group-hover:shadow-md transition-shadow">
                            ...
                            <div className="flex flex-col space-y-1 text-center">
                                ...
                                <span className="font-sans text-xs text-gold font-bold">$29.99</span>
                            </div>
                        </Link>
                        ...
                        <Link 
                            ...
                            onClick={(e) => handleOpenCustomizer('heirloom-walnut-ring-dish', e)}
                            className="group flex flex-col space-y-4 cursor-pointer"
                        >
                            <div className="relative aspect-square w-full rounded-sm overflow-hidden bg-white/50 border border-espresso/5 shadow-sm group-hover:shadow-md transition-shadow">
                        ...
                        {/* Product 7 */}
                        <Link 
                            href="/products/bespoke-leather-golf-pouch" 
                            onClick={(e) => handleOpenCustomizer('bespoke-leather-golf-pouch', e)}
                            className="group flex flex-col space-y-4 cursor-pointer"
                        >
                            <div className="relative aspect-square w-full rounded-sm overflow-hidden bg-white/50 border border-espresso/5 shadow-sm group-hover:shadow-md transition-shadow">
                        ...
                        <Link 
                            ...
                            onClick={(e) => handleOpenCustomizer('bespoke-engraved-heirloom-bottle-opener', e)}
                            className="group flex flex-col space-y-4 cursor-pointer"
                        >
                            <div className="relative aspect-square w-full rounded-sm overflow-hidden bg-white/50 border border-espresso/5 shadow-sm group-hover:shadow-md transition-shadow">
                            ...
                            <div className="flex flex-col space-y-1 text-center">
                                ...
                                <span className="font-sans text-xs text-gold font-bold">$19.99</span>
                            </div>
                        </Link>
                    </div>
                </div>
            ...
            <section className="w-full py-32 px-6 bg-blush text-center">
                <div className="max-w-4xl mx-auto space-y-10">
                    ...
                    <div className="flex flex-col sm:flex-row flex-wrap justify-center gap-4 pt-4">
                        <Link href="/shop" className="w-full sm:w-auto inline-flex items-center justify-center font-sans transition-all duration-250 ease-in-out uppercase tracking-wider text-xs font-semibold bg-espresso text-cream hover:bg-espresso-light shadow-md px-8 py-3.5">
            ...
            <div className="md:hidden fixed bottom-4 left-4 right-4 z-50">
                <a href="#must-haves" className="flex items-center justify-center w-full bg-espresso text-cream font-sans font-bold uppercase tracking-widest text-sm py-4 rounded shadow-2xl border border-gold/30 hover:bg-espresso/90 transition-colors">
                    Shop the Must-Haves
                </a>
            </div>
