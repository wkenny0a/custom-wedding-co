...
const SECTIONS_DATA = [
    {
        ...
        id: 'handheld-fans',
        shortTitle: 'Personalized Handheld Fans',
        bestFor: 'Outdoor ceremonies, summer weddings, and guest comfort',
        favoriteLabel: 'Top clicked product',
        headline: 'Personalized Handheld Fans for Ceremony Comfort',
