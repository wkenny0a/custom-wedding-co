        ...
        <>
            ...
            >
                ...
                <nav className="flex-1 overflow-y-auto p-6 flex flex-col gap-6">
                    ...
                    <Link href="/wedding-must-haves-2026-2027-v2" onClick={onClose} className="font-serif text-2xl text-espresso hover:text-gold transition-colors">2026/2027 Guide</Link>
                    ...
                    <div className="mt-8 pt-8 border-t border-gold/20 flex flex-col gap-4">
                        ...
                        <Link href="/proofing-process" onClick={onClose} className="font-sans tracking-wide uppercase text-sm text-gray-600 hover:text-gold">How It Works</Link>
