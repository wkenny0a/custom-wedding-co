...
export function HomeBoxConfigurator() {
  return (
    <section className="w-full">
      <div className="flex flex-col lg:flex-row w-full h-[900px] lg:h-[700px]">
        
        {/* Left Side: Bridesmaid Box */}
        <Link 
          href="/gifts/bridesmaid-box"
          className="flex-1 relative group overflow-hidden h-1/3 lg:h-full block cursor-pointer"
        >
        ...
        >
          ...
          <div className="absolute inset-0 z-0">
            <Image 
              src="/images/groom_box_lifestyle_v2.jpeg"
        ...
        >
          ...
          <div className="absolute inset-0 z-0">
            <Image 
              src="/images/welcome_box_lifestyle_v2.jpeg"
          ...
          <div className="absolute inset-0 z-10 flex flex-col justify-end p-8 md:p-12 lg:p-16">
            ...
            <p className="text-white/80 font-sans text-sm md:text-base max-w-md translate-y-4 group-hover:translate-y-0 transition-transform duration-500 delay-75 ease-out mb-8">
              Greet your guests in luxury. Curate the perfect welcome for out-of-towners and destination weddings.
            </p>
