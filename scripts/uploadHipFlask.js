...
var productData = {
    ...
    options: [
        ...
        },
        {
            ...
            input_type: 'select',
            values: [
                { name: 'Custom Flask Only' },
                { name: 'Flask & Gift Box Set' },
            ],
        },
        {
            name: 'Design Style',
            ...
            description: 'Enter preferred botanical/minimalist layout number.',
        },
        {
            ...
            required: true,
            input_type: 'short_text',
            description: 'Enter Name, Initials, Date, and/or Role.',
        },
    ],
